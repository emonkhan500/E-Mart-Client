    ...
    <div className="">
      ...
      <div className="flex flex-col lg:flex-row mt-10 lg:px-20 gap-16">
        ...
        <div className="w-full lg:w-1/3 border-2 border-slate-200 p-3 px-6 rounded-xl">
          <div className="border-2 border-border mt-5">
            <div className="flex justify-between px-10 border-b-2  border-border p-3 text-lg font-bold  ">
              <h1 className="text-[#B6B6B6]">SubTotal</h1>
              <h1 className="text-primary-green text-xl">$10</h1>
            </div>
            {/* apply coupon */}
            <div className="border-b-2 border-border flex justify-between ">
              <input
                className="p-3 focus:outline-none text-black text-lg w-2/3 pl-10 font-bold"
                type="text"
                placeholder="Type Coupon?"
              />
              <button className="text-white bg-primary-green w-1/3 text-2xl">
                Apply
              </button>
            </div>
            <div className="flex justify-between px-10   border-border p-3 text-lg font-bold  ">
              <h1 className="text-[#B6B6B6]">Total</h1>
              <h1 className="text-primary-green text-xl">$10</h1>
            </div>
          </div>
          <button className="text-white bg-primary-green w-full mt-3 p-3 text-lg font-semibold">
            CHECKOUT & PAY
          </button>
        </div>
      </div>
