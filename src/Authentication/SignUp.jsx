      ...
      return (
          ...
          <div className=" lg:w-full lg:max-w-7xl flex flex-col-reverse md:flex-row bg-white rounded-lg  ">
            ...
            <div className="w-full md:w-1/2 p-8 bg-green-500 bg-opacity-5">
              <h2 className="animate__animated animate__bounceIn animate__slow text-3xl font-bold text-[#3BB77E] lg:mt-8 mb-2">Welcome To E-Mart !</h2>
              ...
              <form onSubmit={handleSignUp} className="mt-6">
                <div className="mb-4 animate__animated animate__lightSpeedInLeft animate__slow" >
                  <label className="text-[#253D4E] block  text-sm font-bold mb-2" htmlFor="name">
                    Name
                  </label>
                  <input
                    type="text"
              ...
              <p className="text-[#253D4E] mt-6 text-center font-bold">
                ...
                <Link to="/signin" className="font-bold text-[#3BB77E]">Sign In</Link>
              </p>
            </div>
            ...
            <div className="animate__animated animate__bounceIn animate__slow w-full md:w-1/2  p-6 lg:p-10 bg-green-500 bg-opacity-5">
              <Lottie animationData={signupAnimation} className="w-full h-full max-h-[400px] md:max-h-[500px] lg:max-h-[600px]" />
            </div>
          </div>
        </div>
        );
