...
const Dashboard = () => {
  ...
  return (
    <div className="w-full  px-3 mx-auto">
        <Nav></Nav>
        <h1 className="text-4xl font-bold mt-16 text-[#3BB77E] text-center quick mb-7">DASHBOARD</h1>
  ...
  <li className="text-center">
    ...
    >
      <AiOutlineUnorderedList />ADD PRODUCT
    </NavLink>
  </li>
  <li className="text-center">
    <NavLink 
  ...
  <li className="text-center">
    ...
    > 
      <AiOutlineUnorderedList />MANAGE PRODUCT
    </NavLink>
  </li>
  <li className="text-center"> 
    <NavLink 
    ...
    > 
      <AiOutlineUnorderedList />MANAGE USER
    </NavLink>
  </li>
  <li className="text-center">
  <button 
