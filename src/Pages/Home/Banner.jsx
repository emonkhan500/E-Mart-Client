...
const Banner = () => {
  return (
    <div className="w-full max-w-[1586px] mx-auto px-4 md:px-8 h-[200px] md:h-[380px] lg:h-[580px]   lg:mx-4  flex justify-center">
      <div className="carousel  relative">
        ...
        <div id="slide1" className="carousel-item relative w-full">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 -bottom-2  md:bottom-0">
            <a href="#slide2" className=" px-3 md:px-4 lg:px-6 py-1 md:py-2 lg:py-4 rounded-full bg-[#3BB77E] text-white md:text-xl mr-5">
              ❮
            </a>
            <a href="#slide2" className="px-3 md:px-4 lg:px-6 py-1 md:py-2 lg:py-4 rounded-full bg-[#3BB77E] text-white  md:text-xl">
              ❯
            </a>
          </div>
        </div>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          {/* Navigation */}
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 -bottom-2  md:bottom-0">
            <a href="#slide1" className=" px-3 md:px-4 lg:px-6 py-1 md:py-2 lg:py-4 rounded-full bg-[#3BB77E] text-white md:text-xl mr-5">
              ❮
            </a>
            <a href="#slide1" className="px-3 md:px-4 lg:px-6 py-1 md:py-2 lg:py-4 rounded-full bg-[#3BB77E] text-white  md:text-xl">
              ❯
            </a>
          </div>
        </div>
