      ...
      <div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 md:mt-16">
          ...
          <div className="lg:mt-10">
            ...
            <h1 className="text-primary-text text-2xl lg:text-5xl font-bold pb-7 pt-3">
              Meet Our Expert Team
            </h1>
            <p className="text-primary-gray lg:text-lg">
          ...
          <div>
            <div className="rounded">
              <img
                ...
                alt=""
                className="lg:w-[400px] lg:h-[380px] bg-orangee"
              />
            </div>
            {/* relative div */}
            <div className="text-center relative w-11/12 md:w-10/12 lg:w-[280px] xl:w-[375px] bg-white rounded shadow-lg px-3 py-1 -top-16 left-3">
              <h1 className="quick text-xl font-bold text-primary-text mt-1 mb-2">
                Md. Emon Khan
              </h1>
              <p className="text-primary-gray">CEO & FOUNDER</p>
          ...
          <div>
            <div className="rounded">
              <img
                src="https://i.ibb.co.com/N6bsPvR2/image-1.png"
                alt=""
                className="lg:w-[400px] lg:h-[380px] bg-bg-honeydew  "
              />
            </div>
            {/* relative div */}
            <div className="text-center relative w-11/12 md:w-10/12 lg:w-[280px] xl:w-[375px] bg-white rounded shadow-lg px-3 py-1 -top-16 left-3">
              ...
              <p className="text-primary-gray">WEB DEVELOPER</p>
